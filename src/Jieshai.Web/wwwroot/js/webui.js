...
(function($){
    ...
    $.webui.form.inputTypes = [
        ...
        {name: "imageUpload", selector: ".webui-imageUpload"},
        {name: "fileUpload", selector: ".webui-fileUpload"}
    ];
...
$.widget( "webui.datagrid", $.webui.input, {
    ...
    _renderEmptyMessageElement: function(){
        this._emptyMessageElement = $('<div style="display: none;text-align:center;">无</div>');
